                                            ...
                                            <?php if ($subjects->num_rows > 0) : ?>
                                                <?php while ($data = mysqli_fetch_array($subjects)) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="app/controllers/subject/edit.php?id=<?php echo $data['id']; ?>" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></a>
                                                            <a href="app/controllers/subject/delete.php?del=<?php echo $data['id']; ?>" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            <?php else : ?>
